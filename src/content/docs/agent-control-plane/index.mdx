...
<table class="status-table">
  ...
  <tbody>
    ...
    <tr>
      <td><code>sprite-mobile-conductor</code></td>
      <td>Distributed task conductor</td>
      <td><span class="badge badge-active">Active</span></td>
    </tr>
    <tr>
      <td><code>sprite-mobile-worker-1</code></td>
      <td>Worker node</td>
      <td><span class="badge badge-active">Active</span></td>
    </tr>
    <tr>
      <td><code>sprite-mobile-worker-2</code></td>
      <td>Worker node</td>
      <td><span class="badge badge-active">Active</span></td>
    </tr>
  </tbody>
...
**Do not use `hammer`, `anvil`, or `forge` for general tasks** — they're dedicated to automated code review workflows triggered by git push.
:::
