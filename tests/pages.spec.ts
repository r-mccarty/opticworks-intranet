...
test.describe('All Documentation Pages', () => {
  const pages = [
    ...
    { path: '/projects/rs-1/', name: 'RS-1 Overview' },
    { path: '/projects/rs-1/architecture/', name: 'RS-1 Architecture' },
    { path: '/projects/rs-1/development/', name: 'RS-1 Development' },
    { path: '/projects/rs-1/deployment/', name: 'RS-1 Deployment' },
